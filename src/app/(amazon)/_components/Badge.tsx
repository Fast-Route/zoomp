...
function Badge({ onBadge, open, animate }: BadgeProps) {
    ...
    const mounth = new Date().toLocaleDateString("en-US", {
        month: "long",
        day: "numeric",
    });
    ...
    return (
        ...
        >
            <motion.div
                className={
                    open
                        ? `fixed bottom-0 left-0 w-full h-[93vh] ${
                              animate && "ease-in-out duration-300"
                          }`
                        : `fixed bottom-[-150%] left-0 w-full h-[93vh] ${
                              animate && "ease-in-out duration-300"
                          }`
                }
                drag={!disableAxis && "y"}
            ...
            >
                ...
                >
                    <div className="relative flex w-full bg-[var(--fourth)] rounded-t-xl justify-center items-center px-4">
                    ...
                    <div className="flex flex-col items-center mt-4 gap-2">
                        <div
                            ...
                            className="bg-cover bg-center bg-no-repeat w-[300px] h-[300px] rounded-full border-4 border-gray-300"
                        ></div>
                        <h1 className="text-3xl mt-4 text-black">{user.nameBadge}</h1>
